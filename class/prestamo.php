    ...
    $sql = "call disponibilidad2('$f_prestamo','$f_devolucion','$h_ingreso', '$h_salida','$ambiente', '$lunes','$martes','$miercoles','$jueves','$viernes','$sabado','$domingo')";
        ...
        if ($conexion ->affected_rows > 0)
        {
           ...
           //$p = explode (" ",$ambiente);
            ...
            $sql .= "values('$ambiente','$f_prestamo','$f_devolucion','$h_ingreso', '$h_salida','$ficha','$instructor','$lunes','$martes','$miercoles','$jueves','$viernes','$sabado','$domingo','$competencia','$producto','$resutado','$fase')";
            $resultado = $conexion->query($sql);
               //echo $sql;
