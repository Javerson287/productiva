...
//echo $ficha;
    ...
    if ( $f_prestamo && $f_devolucion )
    {
        ...
        prestamos::ingresar_prestamo($ficha,$fase,$producto,$resutado,$ambiente,$instructor,$f_prestamo,$f_devolucion,$h_ingreso, $h_salida,$lunes,$martes,$miercoles,$jueves,$viernes,$sabado,$domingo,$competencia);
